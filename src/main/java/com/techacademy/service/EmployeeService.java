...
public class EmployeeService {
    ...
    public ErrorKinds update(Employee employee, String code) {
        ...
        System.out.println("/*******************************/");
        System.out.println("社員番号:"+employee.getCode());
        System.out.println("パスワード:"+employee.getPassword());
        System.out.println("権限:"+employee.getRole());
        System.out.println("登録日時:"+employee.getCreatedAt());
        System.out.println("更新日時:"+employee.getUpdatedAt());
        System.out.println("/*******************************/");

        employeeRepository.save(employee);

        System.out.println("従業員更新　save完了");
